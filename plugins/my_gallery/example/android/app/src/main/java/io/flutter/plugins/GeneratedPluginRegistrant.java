...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.my_gallery.MyGalleryPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin my_gallery, com.example.my_gallery.MyGalleryPlugin", e);
    }
    try {
